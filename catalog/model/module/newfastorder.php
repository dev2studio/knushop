...
class ModelModuleNewfastorder extends Model {	
	...
	public function addOrder($data, $product_options) {	
		...
		/*--------------------------*/
			...
			$this->db->query("UPDATE " . DB_PREFIX . "product_option_value SET quantity = (quantity - " . (int)$data['quantity'] . ") WHERE product_option_value_id = '" . (int)$product_option['product_option_value_id'] . "' AND subtract = '1'");
