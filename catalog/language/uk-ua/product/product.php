...
$_['entry_not_size']                          = 'Нема потрібного ';
$_['entry_not_size_later']                    = 'у';

$_['text_share1']                               = 'Натискаючи кнопку "Замовити", я приймаю умови <a href="/terms-of-use-and-privacy"  class="transition">Політики конфіденційності</a>';
$_['text_share2']                               = 'Коли у нас буде поповнення товарів, ми зв`яжемось із Вами!';

$_['text_share3']                               = 'Залиште Ваші контактні дані - коли у нас буде поповнення товарів, ми зв`яжемось із Вами!';

$_['text_share4']                               = 'Забронювати';
