...
$_['text_size_chart']                         = 'Размерная сетка';
$_['text_care']                               = 'Уход';
...
$_['entry_not_size']                          = 'Нету нужного ';
$_['entry_not_size_later']                    = 'а';

$_['text_share1']                               = 'Нажимая кнопку «Заказать», я принимаю условия <a  class="transition" href="/terms-of-use-and-privacy"> Политики конфиденциальности </a>';
$_['text_share2']                               = 'Когда у нас будет ваш размер товара, мы свяжемся с вами!';
$_['text_share3']                               = 'Оставьте Ваши контактные данные - когда у нас будет пополнение товаров, мы свяжемся с вами!';

$_['text_share4']                               = 'Забронировать';
