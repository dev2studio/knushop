...
class ControllerExtensionModuleBrainyFilter extends Controller {
	...
	public function index($moduleSettings) 
    {
		...
		$this->document->addStyle('catalog/view/theme/basel/stylesheet/brainyfilter.css');
		...
		$this->_data['lang_text_price']      = $this->language->get('text_sub_price');
		...
		$this->_data['lang_filter_trigger']  = $this->language->get('lang_filter_trigger');
		$this->_data['lang_search_placeholder']      = $this->language->get('text_search_placeholder');
...
//            }
    ...
    public function cron()
    {
        ...
        require_once 'admin/model/extsnsion/module/brainyfilter.php';
