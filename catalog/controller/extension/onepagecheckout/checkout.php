...
class ControllerExtensionOnepagecheckoutCheckout extends Controller {
	...
	public function index(){
		...
		$data['register_tab'] = (!empty($onepagecheckout_manage['general']['register'][$this->config->get('config_language_id')])) ? $onepagecheckout_manage['general']['register'][$this->config->get('config_language_id')] : $this->language->get('button_checkout_register');
		$data['guest_tab'] = (!empty($onepagecheckout_manage['general']['guest'][$this->config->get('config_language_id')])) ? $onepagecheckout_manage['general']['guest'][$this->config->get('config_language_id')] : $this->language->get('button_checkout_guest');
		$data['login_tab'] = (!empty($onepagecheckout_manage['general']['login'][$this->config->get('config_language_id')])) ? $onepagecheckout_manage['general']['login'][$this->config->get('config_language_id')] : $this->language->get('button_checkout_login');
		...
		if($this->config->get('onepagecheckout_field_layout')){
		  $data['class1'] = 'col-sm-12 col-md-4';
		  $data['class2'] = 'col-sm-12 col-md-8';
		}else{
		 $data['class1'] = 'col-sm-12 col-md-6';
		  $data['class2'] = 'col-sm-12 col-md-6';
		}
