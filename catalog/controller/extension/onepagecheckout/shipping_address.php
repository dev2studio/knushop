...
class ControllerExtensionOnepagecheckoutShippingAddress extends Controller {
	...
	public function index(){
		...
		foreach($fields as $key => $feild){
			...
			if($status){
				$data['feilds'][$key]=array(
					...
					'placeholder'	=> ($onepagecheckout_manage['delivery_detail'][$key]['placeholder'][$this->config->get('config_language_id')] ? $onepagecheckout_manage['delivery_detail'][$key]['placeholder'][$this->config->get('config_language_id')] : $this->language->get('placeholder_'.$key))
				);
			}
		}
		...
		$data['entry_heading'] = ($onepagecheckout_manage['delivery_detail']['heading_title'][$this->config->get('config_language_id')] ? $onepagecheckout_manage['delivery_detail']['heading_title'][$this->config->get('config_language_id')] : $this->language->get('text_delivery_address'));
		...
		foreach ($custom_fields as $custom_field) {
			...
			if ($custom_field['location'] == 'address') {
				...
				if ($custom_field['type'] == 'text' || $custom_field['type'] == 'textarea' || $custom_field['type'] == 'file' || $custom_field['type'] == 'date' || $custom_field['type'] == 'datetime' || $custom_field['type'] == 'time') {
					$data['address_custom_fields'][] = $address_custom_field[$custom_field['custom_field_id']];
