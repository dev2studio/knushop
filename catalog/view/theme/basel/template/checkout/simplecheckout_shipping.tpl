<div class="simplecheckout-block" id="simplecheckout_shipping" <?php echo $hide ? 'data-hide="true"' : '' ?> <?php echo $display_error && $has_error ? 'data-error="true"' : '' ?>>
    ...
    <div class="simplecheckout-block-content">
        <?php if (!empty($shipping_methods)) { ?>
                        ...
                        <?php foreach ($shipping_method['quote'] as $quote) { ?>
                            <div class="radio">
                                <label for="<?php echo $quote['code']; ?>">
                                    <input  onchange="kwe()" type="radio" data-onchange="reloadAll" name="shipping_method" <?php echo !empty($quote['dummy']) ? 'disabled="disabled"' : '' ?> <?php echo !empty($quote['dummy']) ? 'data-dummy="true"' : '' ?> value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>" <?php if ($quote['code'] == $code) { ?>checked="checked"<?php } ?> />
            ...
            <?php } ?>
            <input type="hidden" id="shipping_method_currentas" name="shipping_method_current" value="<?php echo $code ?>" />
            <input type="hidden" id="shipping_method_currentas2" name="shipping_method_checked" value="<?php echo $checked_code ?>" />
        <?php } ?>
