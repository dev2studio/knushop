...
<span class="cart-name1"><?php echo $heading_title; ?></span>
            ...
            <tbody>
              ...
              <td class="remove-cell text-center">
                ...
                <td class="name"><a class="hover_uline" href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                  ...
                  <small class="hidden-md hidden-lg"><br /><?php echo $column_price; ?>: <?php echo $product['price']; ?></small>
                  </td>
...
<!-- <input type="number" min="1" step="1" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" oninput="updateCart('<?php echo $product['cart_id']; ?>', $(this).val())" /> -->
          ...
          <div class="col-xs-6 text-right"><button type="submit" class="btn btn-primary"><?php echo $button_update; ?></button></div>
          </div>
