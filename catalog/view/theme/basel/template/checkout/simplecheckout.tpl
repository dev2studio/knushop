<?php if (!$ajax && !$popup && !$as_module) { ?><?php $simple_page = 'simplecheckout'; $heading_title .= $display_weight ? '&nbsp;(<span id="weight">'. $weight . '</span>)' : '';
include $simple_header;
?>


<div style="clear: both;"><span class="cart-name1"><?php echo $text_cart; ?></span>
</div>
<style>
...
<div class="sdkweewe" data-ej="0"></div>
            ...
            <?php if (!$cart_empty) { ?>
                ...
                <?php
                    $replace = array(
                        ...
                        '{/three_column}'    => '</div>',
                        '{left_column}'      => '<div class="simplecheckout-left-column"><div class="totals-slip">',
                        '{/left_column}'     => '</div></div>',
                        '{right_column}'     => '<div class="simplecheckout-right-column"><div class="totals-slip">',
...
.row-customer_field26 .checkbox{
padding-top: 16px;
}

.row-customer_field26 .checkbox label{
    line-height: 17px;
}
