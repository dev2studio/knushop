<div class="extpanel extpanel-default">
	...
	<div class="extpanel-body">
		<div class="row" id="account">
			<div class="form-group col-sm-12" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
				...
				<?php } ?>
				<?php }else{ ?>
					<select class="form-control" name="personal_details[customer_group_id]">
					<?php foreach ($customer_groups as $customer_group) { ?>
						<?php if ($customer_group['customer_group_id'] == $customer_group_id){
			...
			<!-- First Name -->
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<input type="text" name="personal_details[firstname]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-firstname" class="form-control" />
				</div>
			<?php } ?>
			...
			<!-- Last Name -->
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<input type="text" name="personal_details[lastname]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-lastname" class="form-control" />
				</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>" >
				...
				<input type="text" name="personal_details[email]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-email" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?>  <?php echo ($feild['required'] ? 'required' : ''); ?>" >
				...
				<input type="text" name="personal_details[telephone]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-telephone" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>" >
				...
				<input type="text" name="personal_details[fax]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-fax" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>" >
				...
				<input type="text" name="personal_details[company]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-company" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<input type="text" name="personal_details[address_1]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-address-1" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<input type="text" name="personal_details[address_2]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-address-2" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<input type="text" name="personal_details[city]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-city" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class=" form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<input type="text" name="personal_details[postcode]" value="<?php echo $postcode; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-postcode" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo ($feild['chide'] ? 'hide' : ''); ?> <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<select name="personal_details[country_id]" id="input-payment-country" class="form-control">
			...
			<div class="form-group <?php echo ($feild['zhide'] ? 'hide' : ''); ?> <?php echo $class1; ?>    <?php echo ($feild['required'] ? 'required' : ''); ?>">
				...
				<select name="personal_details[zone_id]" id="input-payment-zone" class="form-control">
				</select>
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?> register_fields">
				...
				<input type="password" name="personal_details[password]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-password" class="form-control" />
			</div>
			<?php } ?>
			...
			<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?> register_fields">
				...
				<input type="password" name="personal_details[confirm]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-confirm" class="form-control" />
			</div>
			<?php } ?>
			...
			<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="<?php echo $class1; ?> form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				...
				<select name="personal_details[custom_field][<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control">
			...
			<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="<?php echo $class1; ?> form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
				<input type="text" name="personal_details[custom_field][<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
			</div>
			<?php } ?>
			...
			<div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="<?php echo $class1; ?> form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
				<textarea name="personal_details[custom_field][<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $custom_field['value']; ?></textarea>
			</div>
			<?php } ?>
		...
		<div class="checkbox register_fields extsm-12">
			<label for="newsletter">
				<input <?php echo $account_terms; ?> type="checkbox" name="personal_details[newsletter]" value="1" id="newsletter" />
...
<?php } ?>
	$.ajax({
		url: 'index.php?route=extension/onepagecheckout/checkout/customfield&customer_group_id=' + this.value,
		dataType: 'json',
...
$('#account input[name=\'personal_details[postcode]\']').on('keyup', function(){
