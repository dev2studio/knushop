		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group required">
					...
					<input type="text" name="email" value="" placeholder="<?php echo $entry_email_placeholder; ?>" id="input-email" class="form-control" />
				</div>
				<div class="form-group required">
					<label class="control-label" for="input-password"><?php echo $entry_password; ?></label>
                    <a class="pull-right" href="<?php echo $forgotten; ?>"><?php echo $text_forgotten; ?></a>
					<input type="password" name="password" value="" placeholder="<?php echo $entry_password_placeholder; ?>" id="input-password" class="form-control" />
					</div>
				<input type="button" value="<?php echo $button_login; ?>" id="button-login" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-contrast btn-block button-login" />
			</div>
		</div>
	</div>
</div>
