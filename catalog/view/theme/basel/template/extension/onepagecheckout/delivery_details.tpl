<div class="extpanel extpanel-default">
	...
	<div class="extpanel-body">
		<form>
			...
			<?php } ?>
			<div class="row" id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
				...
				<?php if($feild['key']=='firstname'){ ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						<label class="control-label" for="input-shipping-firstname"><?php echo $feild['label']; ?></label>
							<input type="text" name="delivery_details[firstname]" value="<?php echo $firstname; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-firstname" class="form-control" />
					</div>
				<?php } ?>
				 ...
				 <?php if($feild['key']=='lastname'){ ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<input type="text" name="delivery_details[lastname]" value="<?php echo $lastname; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-lastname" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<input type="text" name="delivery_details[company]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-company" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						<label class="control-label" for="input-shipping-address-1"><?php echo $feild['label']; ?></label>
						 <input type="text" name="delivery_details[address_1]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-address-1" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<input type="text" name="delivery_details[address_2]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-address-2" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<input type="text" name="delivery_details[city]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-city" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<input type="text" name="delivery_details[postcode]" value="<?php echo $postcode; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-shipping-postcode" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="form-group <?php echo ($feild['chide'] ? 'hide' : ''); ?> <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<select name="delivery_details[country_id]" id="input-shipping-country" class="form-control">
					...
					<div class="form-group <?php echo ($feild['zhide'] ? 'hide' : ''); ?> <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
						...
						<select name="delivery_details[zone_id]" id="input-shipping-zone" class="form-control"></select>
					</div>
					<?php } ?>
					<?php } ?>
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						...
						<select name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control">
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						<label class="control-label" for="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
						<input type="text" name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
					</div>
					<?php } ?>
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						<label class="control-label" for="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
						<textarea name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $custom_field['value']; ?></textarea>
					</div>
					<?php } ?>
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						<label class="control-label" for="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
							<div class="input-group date">
								<input type="text" name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						...
						<div class="input-group time">
								<input type="text" name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="HH:mm" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
								<span class="input-group-btn">
								<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
								</span>
						</div>
					...
					<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
						...
						<div class="input-group datetime">
							<input type="text" name="delivery_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
							<span class="input-group-btn">
								<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
							</span>
						</div>
