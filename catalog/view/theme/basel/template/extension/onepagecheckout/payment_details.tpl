<div class="extpanel extpanel-default">
	<div class="extpanel-heading">
		<h4 class="extpanel-title"><?php echo $entry_heading; ?></h4>
	</div>
...
<?php if($feild['key']=='firstname'){ ?>
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<input type="text" name="payment_details[firstname]" value="<?php echo $firstname; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-firstname" class="form-control" />
				</div>
				<?php } ?>
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<input type="text" name="payment_details[lastname]" value="<?php echo $lastname; ?>" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-lastname" class="form-control" />
				</div>
				<?php } ?>
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<?php echo $entry_address_1; ?>
					 <input type="text" name="payment_details[address_1]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-address-1" class="form-control" />
				</div>
				<?php } ?>
				...
				<div class="form-group <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<?php echo $entry_city; ?>
					<input type="text" name="payment_details[city]" value="" placeholder="<?php echo $feild['placeholder']; ?>" id="input-payment-city" class="form-control" />
				</div>
				<?php } ?>
				...
				<div class="form-group <?php echo ($feild['zhide'] ? 'hide' : ''); ?> <?php echo $class1; ?> <?php echo ($feild['required'] ? 'required' : ''); ?>">
					...
					<?php echo $entry_zone; ?>
					<select name="payment_details[zone_id]" id="input-payment-zone" class="form-control"></select>
				</div>
				<?php } ?>
				<?php } ?>
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					...
					<select name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control">
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					<label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
					<input type="text" name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
				</div>
				<?php } ?>
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					<label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
					<textarea name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $custom_field['value']; ?></textarea>
				</div>
				<?php } ?>
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					<label class="control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
						<div class="input-group date">
							<input type="text" name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					...
					<div class="input-group time">
						<input type="text" name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="HH:mm" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
						<span class="input-group-btn">
							<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
						</span>
					</div>
				...
				<div class="<?php echo $class1; ?> form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
					...
					<div class="input-group datetime">
						<input type="text" name="payment_details[custom_field][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field['value']; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
						<span class="input-group-btn">
							<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
						</span>
					</div>
