<div id="popup-quickorder">
	...
	<div class="popup-center">
		<form id="fastorder_data" enctype="multipart/form-data" method="post" name="fastorder">
...
<div class="option-fastorder">
    <div class="options">
        <?php foreach ($options as $option) { ?>
            ...
            <div id="option-fast-<?php echo $option['product_option_id']; ?>" class="col-sm-12 col-xs-12 col-md-12 text-center option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              <div class="text-danger option-error-<?php echo $option['product_option_id']; ?>"></div>
...
<?php } ?>
		...
		<div class="col-sm-6 col-sm-12 col-md-12 text-center form-group <?php echo $config_fields_firstname_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
			<div class="input-group margin-bottom-sm custom__quick-order__phone-box">
		...
		<div class="col-sm-12 col-sm-12 col-md-12 form-group <?php echo $config_fields_phone_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
			<div class="input-group margin-bottom-sm custom__quick-order__phone-box" id="js_custom__quick-order__phone_valid">
				 <input id="contact-phone" class="form-control contact-phone" type="text" pattern="\+380\s?[\(]{0,1}[0-9]{2}[\)]{0,1}\s?\d{3}[-]{0,1}\d{2}[-]{0,1}\d{2}" placeholder="<?php echo $config_placeholder_fields_phone[$lang_id]['config_placeholder_fields_phone']; ?>" value="" name="phone" required>
				<span class="input-group-addon"><i class="icon-append-1 fa fa-phone-square fa-fw"></i></span>
			</div>
		</div>
		 <?php } ?>
		 <?php if($on_off_fields_email) { ?>
		<div class="col-sm-6 col-sm-12 col-md-12 text-center form-group <?php echo $config_fields_email_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
		<div class="input-group margin-bottom-sm custom__quick-order__phone-box">
	  ...
	  <?php if($on_off_fields_comment) { ?>
		<div class="col-sm-6 col-om-12 col-md-12 text-center form-group <?php echo $config_fields_comment_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
		<div class="input-group margin-bottom-sm custom__quick-order__phone-box">
	...
	<div class="popup-footer">
        ...
        <div id="quickorder_btn">
			<button id="quickorder_btn__submit" type="button" onclick="quickorder_confirm();" class="btn btn-quickorder-one"><i class="<?php echo $icon_send_fastorder;?> fa-fw"></i> <?php echo $button_send; ?></button>
		</div>
...
<!-- <script>
$(function(){
  $("#contact-phone").mask("+380 (999) 999-9999");
});	
</script> -->
<script>
