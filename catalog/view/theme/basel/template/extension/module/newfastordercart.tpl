<div id="popup-quickorder">
		...
		<?php if ($products) { ?>
			...
			<?php if($on_off_fields_phone == '1') { ?>
				<div class="col-sm-6 col-sm-12 form-group <?php echo $config_fields_phone_requared == '1' ? 'sections_block_rquaired' : 'sections_block' ; ?>">
					<div class="input-group margin-bottom-sm">
						 <input id="contact-phone" class="form-control contact-phone" type="text" pattern="0[0-9]{9}" required placeholder="<?php echo $config_placeholder_fields_phone[$lang_id]['config_placeholder_fields_phone']; ?>" value="" name="phone">
	...
	<div class="popup-footer">
		...
		<div>
			...
			<button type="button" onclick="quickorder_confirm_checkout();" class="btn btn-contrast"><i class="<?php echo $icon_send_fastorder;?> fa-fw"></i> <?php echo $button_send; ?></button>
		</div>
		<?php } else { ?>
