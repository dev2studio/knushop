...
<?php $link  = ($section['link']!=''?$section['link']:false); ?>

<?php if($link != false){ ?>
<img style="cursor:pointer" src="<?php echo $section['thumb_image']; ?>" <?php echo ($link!=false?'onclick="window.location.href = `'.$link.'`;"':'');?>  data-src="<?php echo $section['thumb_image']; ?>" class="slide-bg" alt="">
<?php }else{ ?>
...
<!-- Text layer -->
    <div class="ms-layer ms-caption" style="font-family:<?php echo $group['font']; ?>;font-weight:<?php echo $group['fontweight']; ?>;font-size:<?php echo $group['fontsize']; ?>;color:<?php echo $group['color']; ?>;background-color:<?php echo $group['bg']; ?>;padding:<?php echo $group['padding']; ?>;border-radius:<?php echo $group['radius']; ?>;white-space:nowrap; <?php echo $group['customcss']; ?>;"
...
<!-- Button layer -->
    <a class="ms-layer ms-btn <?php echo $group['button_class']; ?> <?php if ($group['button_target']) { echo 'external'; } ?>" href="<?php echo $group['button_href']; ?>" style="font-family:<?php echo $group['font']; ?>;font-weight:<?php echo $group['fontweight']; ?>;white-space:nowrap;" 
