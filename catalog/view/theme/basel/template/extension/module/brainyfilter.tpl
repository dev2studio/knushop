...
<div class="bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">
    ...
    <div class="widget bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
        <!--
        <div class="widget-title box-heading">
        <p class="main-title"><span><?php echo $lang_block_title; ?></span></p>
        <?php if ($isHorizontal) : ?><a class="bf-toggle-filter-arrow"></a><input type="reset" class="bf-buttonclear" onclick="BrainyFilter.reset();" value="<?php echo $reset; ?>" /><?php endif; ?>
        <p class="widget-title-separator"><i class="icon-line-cross"></i></p>
        </div>
        -->
        
        <div class="brainyfilter-panel <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form 
                    <?php if ($settings['behaviour']['product_count']) : ?> bf-with-counts<?php endif; ?> 
                    <?php if ($settings['behaviour']['rounded_img']) : ?> bf-rounded-img<?php endif; ?> 
                    <?php if ($settings['behaviour']['attribute_groups']) : ?> bf-show-attribute-titles<?php endif; ?> 
                  ...
                  data-submit-typekeeper="<?php echo $settings['submission']['submit_type']; ?>"
                ...
                <?php foreach ($filters as $i => $section) : ?>
                        ...
                        <div class="bf-attr-block-cont">
                            <div class="bf-price-container box-content bf-attr-filter">
                                ...
                                <div class="bf-cur-symb">
                                    <input type="hidden" class="bf-range-min" name="bfp_price_min" value="<?php echo $lowerlimit; ?>" size="4" />
                                    <input type="hidden" class="bf-range-max" name="bfp_price_max" value="<?php echo $upperlimit; ?>" size="4" /> 
                                <?php echo $lang_text_price; ?> 
                                <b><?php echo $currency_symbol; ?><span id="bf-price-min"><?php echo $lowerlimit; ?></span></b> —
                                <b><?php echo $currency_symbol; ?><span id="bf-price-max"><?php echo $upperlimit; ?></span></b>
                                </div>
                                <?php else : ?>
                    ...
                    <?php elseif ($section['type'] == 'search') : ?>
                        ...
                        <div class="bf-attr-block-cont">
                            <div class="bf-search-container bf-attr-filter">
                                <div>
                                    <input type="text" class="bf-search" placeholder="<?php echo $lang_search_placeholder; ?>" name="bfp_search" value="<?php echo $bfSearch; ?>" /> 
                                </div>
                            </div>
                        </div>
                        </div>
                            ...
                            <?php else : ?>
                                ...
                                <div class="bf-attr-filter bf-attr-<?php echo $groupUID; ?> bf-row <?php if (isset($totals) && isEmptyStock($groupUID, $catId, $postponedCount, $totals, $selected) && $settings['behaviour']['hide_empty']): ?>bf-disabled<?php endif; ?>">
                                    ...
                                    <span class="bf-cell bf-c-2 bf-cascade-<?php echo $cat['level']; ?>">
                                        ...
                                        <label for="bf-attr-<?php echo $groupUID . '_' . $catId . '_' . $layout_id; ?>" class="bf-attr-<?php echo $groupUID . '_' . $catId; ?>">
                                            <?php echo $cat['name']; ?>
                                        </label>
                                    </span>
                    ...
                    <?php else : ?>
                        ...
                        <?php foreach ($section['array'] as $groupId => $group) : ?>
                            ...
                            <div class="bf-attr-header<?php if (isset($group['group_id'])) echo ' spec'; ?><?php if ($section['collapsed']) : ?> bf-collapse<?php endif; ?><?php if (!$i) : ?> bf-w-line<?php endif; ?>">
                                    ...
                                    <div class="bf-grid">
                                        ...
                                        <div class="bf-grid-item">
                                            <input id="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>" class="bf-hidden"
                                                    ...
                                                    <?php if (isset($selected[$groupUID]) && in_array($valueId, $selected[$groupUID])) : ?>checked="checked"<?php endif; ?> />
                                            <label for="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>" class="bf-attr-<?php echo $groupUID . '_' . $valueId; ?>"><div class="img_wrap"><img src="image/<?php echo $value['image'];?>" data-toggle="tooltip" data-title="<?php echo $value['name']; ?>" /></div>
                                            </label>
                                    ...
                                    if (isset($totals) && isEmptyStock($groupUID, $valueId, $postponedCount, $totals, $selected) && $settings['behaviour']['hide_empty']):
                                        ...
                                        <span class="bf-cell bf-c-1">
                                            <input id="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"
                                                   ...
                                                   <label for="bf-attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"></label>                                        </span>
                                        <span class="bf-cell bf-c-2 <?php if ($section['type'] == 'rating') echo 'bf-rating-' . $valueId; ?>">
                                            ...
                                            class="bf-attr-<?php echo $groupUID . '_' . $valueId; ?> 
                                            <?php if (isset($selected[$groupUID]) && in_array($valueId, $selected[$groupUID])) : ?> is-selected<?php endif; ?>">
                                                <?php if ($section['type'] === 'option') : ?>
                                                    <?php if ($group['mode'] === 'img' || $group['mode'] === 'img_label') : ?>
                                                    <div class="img_wrap"><img src="image/<?php echo $value['image'];?>" alt="<?php echo $value['name']; ?>" /></div>
                                                    <?php endif; ?>
                ...
                <div class="bf-buttonclear-box hidden-xs"<?php if ($isHorizontal && $settings['submission']['submit_button_type'] == 'float') : ?>style="display:none;"<?php endif; ?>>
                <input type="button" value="<?php echo $lang_submit; ?>" class="btn btn-primary bf-buttonsubmit" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;" <?php if ($settings['submission']['submit_button_type'] != 'fix' && $settings['submission']['submit_type'] != 'button' )  : ?>style="display:none;" <?php endif; ?> />
                   <?php if (!$isHorizontal) : ?><input type="reset" class="btn btn-primary bf-buttonclear" onclick="BrainyFilter.reset();return false;" value="<?php echo $reset; ?>" /><?php endif; ?>  
                </div><?php endif; ?>
                <!-- Basel -->
                </div>
                <div class="fixed-filter-btn-holder hidden-sm hidden-md hidden-lg">
                <a class="bf-btn-submit btn btn-contrast" onclick="BrainyFilter.sendRequest();"><?php echo $lang_submit; ?></a>
                <a class="btn btn-default bf-buttonclear" onclick="BrainyFilter.reset();return false;"><?php echo $reset; ?></a>
                </div>
            </form>
        </div>
    </div>
...
$('.filter-trigger-btn').addClass('active').html('<i class="icon-line-menu icon"></i> <b><?php echo $lang_filter_trigger; ?></b>');
});
</script>
<script>
var bfLang = {
