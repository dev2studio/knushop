...
<b class="bordered-list-title invert"><?php echo $text_account; ?></b>
  ...
  <?php } ?>
  <a href="<?php echo $address; ?>"><?php echo $text_address; ?></a> <a href="<?php echo $wishlist; ?>"><?php echo $text_wishlist; ?></a> <a href="<?php echo $order; ?>"><?php echo $text_order; ?></a> <a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a>  <a href="<?php echo $newsletter; ?>"><?php echo $text_newsletter; ?></a>
  <?php if ($logged) { ?>
