    ...
    <div class="grid-holder grid<?php echo $columns; ?> prod_module<?php echo $module; ?> <?php if ($carousel) echo "carousel"; ?> <?php if ($carousel_a && $rows > 1) echo "sticky-arrows"; ?>">
        <?php foreach ($tab['products'] as $product) { ?>
            ...
            <div class="image" <?php if ((isset($columns)) && ($columns == 'list')) echo 'style="width:' . $img_width . 'px"'; ?>>
                ...
                <img class="thumb2" src="<?php echo $product['thumb2']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" />
                <?php } ?>
                </a>
            ...
            <a class="icon is-cart catalog_hide" data-toggle="tooltip" data-placement="left" data-title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="global-cart"></span></a>
            <!--<a class="icon is_wishlist" data-toggle="tooltip" data-placement="left"  data-title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><span class="icon-heart"></span></a>-->
            <!--<a class="icon is_compare" onclick="compare.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-placement="left" data-title="<?php echo $button_compare; ?>"><span class="icon-refresh"></span></a>-->
            <a class="icon is_quickview hidden-xs" onclick="quickview('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-placement="left" data-title="<?php echo $basel_button_quickview; ?>"><span class="icon-magnifier-add"></span></a>
            </div> <!-- .icons-wrapper -->
            </div><!-- .image ends -->
            <div class="caption">
...
<a class="btn btn-contrast" href="/catalog-all/"><?php echo $link_title; ?></a>
</div>
<?php } ?>
</div>
