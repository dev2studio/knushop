...
if(is_array($row['submenu']) && !empty($row['submenu'])) {$class .= ' has-sub dropdown-wrapper from-bottom';$caret = "<i class='fa fa-angle-down'></i>";}
...
<!-- Sub Menu items -->
<div class="dropdown-content sub-holder dropdown-left <?php if ($row['submenu_width'] < '231') echo 'narrow'; ?>" style="width:<?php echo $row['submenu_width']; ?>px;<?php echo $submenu_bg_img; ?>">
