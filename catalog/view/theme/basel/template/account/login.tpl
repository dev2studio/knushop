...
<div class="container full-width">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-md-12 login-content no-min-height">
    <?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 left text-center">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-vertical login-form">
              ...
              <input type="submit" value="<?php echo $button_login_button; ?>" class="btn btn-outline btn-block" />
              <?php if ($redirect) { ?>
