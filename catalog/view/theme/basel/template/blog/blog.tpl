              ...
              <form id="comment_form">
                ...
                <div id="write_response"></div>
                    ...
                    <div class="row">
                        ...
                        <div id="counter-block" class="counter-block"><span id="js_error_counter">0</span>/500</div>
                        <textarea name="comment" maxlength="500" rows="5" id="input-comment" class="form-control"></textarea>
                        </div>
                    </div>
