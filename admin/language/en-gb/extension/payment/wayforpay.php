...
$_['entry_returnUrl'] = 'Return Url refference :<br /><span class="help">http://{your_domain}/index.php?route=payment/wayforpay/response</span>';
$_['entry_serviceUrl'] = 'Server back refference :<br /><span class="help">http://{your_domain}/index.php?route=payment/wayforpay/callback</span>';
