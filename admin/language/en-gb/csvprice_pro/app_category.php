...
$_['text_success_import'] = 'Data import has been completed!<br />Processed <b>%s</b> strings totally!<br /><br /> Updated: <b>%s</b><br />Added: <b>%s</b></b><br />Deleted: <b>%s</b></b><br />Missing: <b>%s</b>';
...
prop_descr[13]="<p><b>Import ID from file</b></p><p>When adding a new category the _ID_ field will be imported as category_id, the import is carried out providing, that such category_id is not in database and the quantity does not exceed the maximum permitted value for category_id.</p>";
