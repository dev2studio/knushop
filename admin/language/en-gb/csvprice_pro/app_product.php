...
$_['entry_import_image_initial_dir'] = 'Start directory';
...
prop_descr[18]="<p>The second field is the value, must be specified as integer or float numbers, where the separator of the float must be a dot.</p>";
...
prop_descr[34]="<p><b>Start directory </b></p><p>This is the directory relative to the main DIR_IMAGE directory, which will be created to import images into it when images are downloaded in automatic mode</p>";
';