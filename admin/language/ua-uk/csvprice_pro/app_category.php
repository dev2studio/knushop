...
$_['text_success_import'] = 'Імпорт даних завершено!<br />Всього оброблено <b>%s</b> рядків!<br /><br /> Оновлено: <b>%s</b><br />Додано: <b>%s</b></b><br />Вилучено: <b>%s</b></b><br />Пропущено: <b>%s</b>';
...
prop_descr[13]="<p><b>Імпортувати id категорії з файлу</ b></ p><p>При додаванні нової категорії буде імпортовано поле _ID_ як category_id, імпорт виконується за умови, що такого category_id немає в базі магазину і число не перевищує максимально допустимого значення для category_id.</ p>";
