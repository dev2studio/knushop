...
$_['prop_descr'] = ' 
prop_descr[0]="<p><b>FTP хост</ b></ p><p>Ім\'я сервера хостингу, IP-адреса сервера хостингу або домен <br> Через двокрапку можна вказати FTP порт (можна не вказувати)<br><br>приклад з FTP портом:<b>exmple.com:21</b></p>";
';