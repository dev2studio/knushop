...
$_['entry_returnUrl'] = 'Ссылка возврата клиента:<br /><span class="help">http://{your_domain}/index.php?route=payment/wayforpay/response</span>';
$_['entry_serviceUrl'] = 'Ссылка возврата для сервера:<br /><span class="help">http://{your_domain}/index.php?route=payment/wayforpay/callback</span>';
