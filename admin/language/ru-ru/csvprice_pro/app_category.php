...
$_['text_success_import'] = 'Импорт данных завершён!<br />Всего обработано <b>%s</b> строк!<br /><br /> Обновлено: <b>%s</b><br />Добавлено: <b>%s</b></b><br />Удалено: <b>%s</b></b><br />Пропущено: <b>%s</b>';
...
$_['entry_import_id'] = 'Импортировать id из файла';
...
prop_descr[13]="<p><b>Импортировать id категории из файла</b></p><p>При добавлении новой категории будет импортировано поле _ID_ как category_id, импорт выполняется при условии, что такого category_id нет в базе магазина и число не превышает максимально допустимого значения для category_id.</p>";
