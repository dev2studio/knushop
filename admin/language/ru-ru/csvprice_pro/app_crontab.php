...
$_['prop_descr'] = ' 
prop_descr[0]="<p><b>FTP хост</b></p><p>Имя сервера хостинга, IP-адрес сервера хостинга или домен<br>Через двоеточие можно указать FTP порт (можно не указывать)<br><br>Пример с FTP портом: <b>exmple.com:21</b></p>";
';