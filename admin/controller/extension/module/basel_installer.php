...
class ControllerExtensionModuleBaselInstaller extends Controller {
	...
	public function install() {
		...
		$xml = file_get_contents(DIR_APPLICATION . '../admin/view/javascript/basel/main_ocmod/basel_theme_3X.ocmod.xml');
		} else {
		$this->load->model('extension/modification');
		$modification_prefix = 'model_extension_modification';
		$xml = file_get_contents(DIR_APPLICATION . '../admin/view/javascript/basel/main_ocmod/basel_theme_23.ocmod.xml');
		}
