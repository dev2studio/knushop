...
class ControllerExtensionModuleNeoSeoImportYml extends NeoSeoController
{
	...
	public function index()
	{
		...
		$data['delete']=$this->url->link('extension/' . $this->_route . '/' . $this->_moduleSysName . '/delete', 'token=' . $this->session->data['token'], 'SSL');
		$data[$this->_moduleSysName . "_cron"]="php " . realpath(DIR_SYSTEM . "../cron/" . $this->_moduleSysName . ".php");
		$data['imports_all']=$this->url->link('extension/' . $this->_route . '/' . $this->_moduleSysName . '/imports_all', 'token=' . $this->session->data['token'], 'SSL');
		$data['import_one']=$this->url->link('extension/' . $this->_route . '/' . $this->_moduleSysName . '/import', 'token=' . $this->session->data['token'], 'SSL');
		$data['clear_database']=$this->url->link('extension/' . $this->_route . '/' . $this->_moduleSysName . '/clear_database', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data["imports"]=$imports;
		$data['params']=$data;
		$data["import_form"]=str_replace(array("\n", "\r", "'"), "", $this->load->view('extension/module/' . $this->_moduleSysName . '_form.tpl', $data));
	...
	public function delete()
	{
		...
		if(!$this->user->hasPermission('modify', 'extension/module/' . $this->_moduleSysName)) {
			...
			$this->template='extension/module/' . $this->_moduleSysName . '.tpl';
			$this->children=array(
				'common/header',
				'common/footer'
			);
			...
			header("location:" . str_replace('&amp;', '&', $this->url->link('extension/module/' . $this->_moduleSysName, 'token=' . $this->session->data['token'], 'SSL')));
		}
	}
