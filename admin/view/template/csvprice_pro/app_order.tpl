									...
									<div class="form-group form-group-sm">
										...
										<div class="col-sm-4">
											<select class="form-control" name="csv_export[filter_time_interval]" id="input_time_interval">
												<?php if (isset($csv_export['filter_time_interval']) && (int)$csv_export['filter_time_interval'] == 0) { ?>
													<option value="0" selected="selected"> <?php echo $text_none; ?> </option>
												<?php } else { ?>
													<option value="0"> <?php echo $text_none; ?> </option>
												<?php } ?>
												
												<?php if (isset($csv_export['filter_time_interval']) && (int)$csv_export['filter_time_interval'] == 1000) { ?>
													<option value="1000" selected="selected"> <?php echo $text_time_interval_day; ?> </option>
												<?php } else { ?>
													<option value="1000"> <?php echo $text_time_interval_day; ?> </option>
												<?php } ?>
												<?php if (isset($csv_export['filter_time_interval']) && (int)$csv_export['filter_time_interval'] == 1007) { ?>
													<option value="1007" selected="selected"> <?php echo $text_time_interval_week; ?> </option>
												<?php } else { ?>
													<option value="1007"> <?php echo $text_time_interval_week; ?> </option>
												<?php } ?>
												<?php if (isset($csv_export['filter_time_interval']) && (int)$csv_export['filter_time_interval'] == 1030) { ?>
													<option value="1030" selected="selected"> <?php echo $text_time_interval_month; ?> </option>
												<?php } else { ?>
													<option value="1030"> <?php echo $text_time_interval_month; ?> </option>
												<?php } ?>
							...
							<div class="row">
								<div class="col-sm-8 col-md-offset-1">
									...
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_order_id; ?></label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="csv_import[field_id]" value="<?php echo (isset($csv_import['field_id'])) ? $csv_import['field_id'] : 'order_id'; ?>">
										</div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_order_status_id; ?></label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="csv_import[field_status_id]" value="<?php echo (isset($csv_import['field_status_id'])) ? $csv_import['field_status_id'] : 'order_status_id'; ?>">
										</div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_order_status; ?></label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="csv_import[field_status]" value="<?php echo (isset($csv_import['field_status'])) ? $csv_import['field_status'] : 'order_status'; ?>">
										</div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"><?php echo $entry_order_comment; ?></label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="csv_import[field_comment]" value="<?php echo (isset($csv_import['field_comment'])) ? $csv_import['field_comment'] : 'comment'; ?>">
										</div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label" data-prop_id="0"><?php echo $entry_order_notify; ?></label>
										<div class="col-sm-7">
											<input class="form-control" type="text" name="csv_import[field_notify]" value="<?php echo (isset($csv_import['field_notify'])) ? $csv_import['field_notify'] : 'notify'; ?>">
										</div>
									</div>
									<div class="form-group form-group-sm">
