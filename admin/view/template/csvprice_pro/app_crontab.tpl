				...
				<div class="row">
					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
						...
						<div class="form-group form-group-sm csvprice_pro_ftp_data">
							<label class="col-sm-5 control-label"  data-prop_id="0"><?php echo $entry_ftp_host; ?></label>
							<div class="col-sm-7">
								<input class="form-control" type="text" name="ftp_host" placeholder="example.com <?php echo isset($text_or) ? $text_or : 'OR' ;?> example.com:21" value="<?php if(isset($job['ftp_host'])) echo $job['ftp_host']; ?>" />
							</div>
						</div>
						<div class="form-group form-group-sm csvprice_pro_ftp_data">
						...
						<div class="form-group form-group-sm csvprice_pro_ftp_data">
							...
							<div class="col-sm-7">
								<select class="form-control" name="ftp_tls">
									<?php if (isset($job['ftp_tls']) && $job['ftp_tls'] == 1) { ?>
									<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
									<option value="0"><?php echo $text_disabled; ?></option>
									<?php } else { ?>
									<option value="1"><?php echo $text_enabled; ?></option>
