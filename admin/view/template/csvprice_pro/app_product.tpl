						...
						<form action="<?php echo $action_import; ?>" method="post" id="form_product_import" enctype="multipart/form-data" class="form-horizontal">
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label" data-prop_id="34"><?php echo $entry_import_image_initial_dir; ?></label>
										<div class="col-sm-7">
											<input type="text" name="csv_import[img_initial_dir]" class="form-control input-sm" value="<?php if(isset($csv_import['img_initial_dir'])) echo $csv_import['img_initial_dir']; ?>" />
										</div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"  data-prop_id="18"><?php echo $entry_import_calc_mode; ?> #1</label>
										<div class="col-sm-4">
											<select name="csv_import[calc_mode_1]" class="form-control input-sm">
												<option value="0" <?php if ( !isset($csv_import['calc_mode_1']) || $csv_import['calc_mode_1'] == 0 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_off; ?></option>
												<option value="1" <?php if ( isset($csv_import['calc_mode_1'])  && $csv_import['calc_mode_1'] == 1 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_multiply; ?></option>
												<option value="2" <?php if ( isset($csv_import['calc_mode_1'])  && $csv_import['calc_mode_1'] == 2 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_divide; ?></option>
												<option value="3" <?php if ( isset($csv_import['calc_mode_1'])  && $csv_import['calc_mode_1'] == 3 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_pluse; ?></option>
												<option value="4" <?php if ( isset($csv_import['calc_mode_1'])  && $csv_import['calc_mode_1'] == 4 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_minus; ?></option>
											</select>
										</div>
										<div class="col-sm-3"><input class="form-control text-right" type="text" name="csv_import[calc_value_1]" value="<?php if(isset($csv_import['calc_value_1'])) echo $csv_import['calc_value_1']; ?>" /></div>
									</div>
									<div class="form-group form-group-sm">
										<label class="col-sm-5 control-label"  data-prop_id="18"><?php echo $entry_import_calc_mode; ?> #2</label>
										<div class="col-sm-4">
											<select name="csv_import[calc_mode_2]" class="form-control input-sm">
												<option value="0" <?php if (!isset($csv_import['calc_mode_2'])  ||  $csv_import['calc_mode_2'] == 0 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_off; ?></option>
												<option value="1" <?php if (isset($csv_import['calc_mode_2'])  && $csv_import['calc_mode_2'] == 1 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_multiply; ?></option>
												<option value="2" <?php if (isset($csv_import['calc_mode_2'])  && $csv_import['calc_mode_2'] == 2 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_divide; ?></option>
												<option value="3" <?php if (isset($csv_import['calc_mode_2'])  && $csv_import['calc_mode_2'] == 3 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_pluse; ?></option>
												<option value="4" <?php if (isset($csv_import['calc_mode_2'])  && $csv_import['calc_mode_2'] == 4 ) echo 'selected'; ?>><?php echo $text_import_calc_mode_minus; ?></option>
											</select>
										</div>
										<div class="col-sm-3"><input class="form-control text-right" type="text" name="csv_import[calc_value_2]" value="<?php if(isset($csv_import['calc_value_2'])) echo $csv_import['calc_value_2']; ?>" /></div>
									</div>
									<div class="form-group form-group-sm">
