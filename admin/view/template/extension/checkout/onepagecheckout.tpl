  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		<button onclick="$('.stay').val(1);" type="submit" form="form-order_success_page" class="btn btn-success"><?php echo $button_save; ?></button>
		</div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default" id="onepagecheackout">
      ...
      <div class="panel-body">
                    ...
                    <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $entry_general; ?></a></li>
						
						<li class="dropdown"><a href="#" data-toggle="dropdown">Layout Setting <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#tab-layout" data-toggle="tab">Layout Setting</a></li>
								<li><a href="#tab-shopping-cart-setting" data-toggle="tab"><?php echo $entry_shopping_cart; ?></a></li>
								<li><a href="#tab-delivery_method-setting" data-toggle="tab"><?php echo $entry_delivery_method; ?></a></li>
								<li><a href="#tab-payment_method-setting" data-toggle="tab"><?php echo $entry_payment_method; ?></a></li>
								<li><a href="#tab-confirm_order-setting" data-toggle="tab"><?php echo $entry_confirm_order; ?></a></li>
						</ul>
						</li>
						<li class="dropdown"><a href="#" data-toggle="dropdown"><?php echo $field_manage; ?> <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#tab-personaldetails-setting" data-toggle="tab"><?php echo $entry_personaldetails; ?></a></li>
								<!--<li><a href="#tab-payment-setting" data-toggle="tab"><?php echo $entry_paymentdetails; ?></a></li>-->
								<li><a href="#tab-delivery-setting" data-toggle="tab"><?php echo $entry_delivery_setting; ?></a></li>
							</ul>
						</li>
						<li class="dropdown"><a href="#" data-toggle="dropdown"><?php echo $entry_language; ?> <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="#tab-general-language-setting" data-toggle="tab"><?php echo $entry_general; ?></a></li>
								<li><a href="#tab-personaldetails-language-setting" data-toggle="tab"><?php echo $entry_personaldetails; ?></a></li>
								<!--<li><a href="#tab-paymentdetails-language-setting" data-toggle="tab"><?php echo $entry_paymentdetails; ?></a></li>-->
								<li><a href="#tab-delivery_detail-language-setting" data-toggle="tab"><?php echo $entry_delivery_setting; ?></a></li>
								<li><a href="#tab-login-language-setting" data-toggle="tab"><?php echo $entry_login; ?></a></li>
								<!--<li><a href="#tab-delivery_method-language-setting" data-toggle="tab"><?php echo $entry_delivery_method; ?></a></li>
								<li><a href="#tab-payment_method-language-setting" data-toggle="tab"><?php echo $entry_payment_method; ?></a></li>-->
								<li><a href="#tab-shopping-cart-language-setting" data-toggle="tab"><?php echo $entry_shopping_cart; ?></a></li>
								<li><a href="#tab-confirm_order-language-setting" data-toggle="tab"><?php echo $entry_confirm_order; ?></a></li>
							</ul>
						</li>
						<li><a href="#tab-restore" data-toggle="tab">Restore Settings</a></li>
					</ul>
                      ...
                      <?php } ?>
						...
						<div class="tab-pane" id="tab-payment_method-setting">
								<fieldset>
									...
									<div class="form-group">
									<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Default Payment Method"><?php echo $entry_payment_method; ?></span></label>
										<div class="col-md-5">
						...
						<div class="tab-pane" id="tab-confirm_order-setting">
							<fieldset>
								...
								<div class="form-group register_newsletter">
									<label class="col-sm-2 control-label" for="input-newsletter">Default Checked Checkout Terms</label>
									<div class="col-sm-10">
										<div class="btn-group" data-toggle="buttons">
											<?php 
						...
						<div class="tab-pane" id="tab-personaldetails-setting">
							<fieldset>
								...
								<div class="form-group">	
									<label class="col-sm-2 control-label " for="input-terms">Account Terms</label>
									<div class="col-sm-3">
								...
								<div class="form-group register_newsletter">
									<label class="col-sm-2 control-label" for="input-newsletter">Default Checked account Terms</label>
									<div class="col-sm-10">
										<div class="btn-group" data-toggle="buttons">
											<?php 
						...
						<div class="tab-pane" id="tab-delivery-setting">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Allow separate delivery address</label>
									<div class="col-sm-10">
										<?php 
