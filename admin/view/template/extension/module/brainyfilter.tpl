        ...
        <div id="bf-adm-main-container">
            ...
            <div id="bf-adm-basic-settings" class="tab-content" data-group="main" style="display:block">
                ...
                <div class="bf-panel">
                    ...
                    <div style="display:block; <?php if ($moduleId === 'basic') : ?> margin-bottom:10px; <?php endif; ?> color:#F66;">
                    <i class="fa fa-info-circle"></i> After the first time you install this module, you need to refresh the modification cache. Do this from: Extensions > Modifications
                    </div>
                                ...
                                <table class="bf-adm-table" style="margin-bottom:0;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bf-intersect center">
                                            <span class="bf-switcher">
                                                <input id="bf-rounded-img" type="hidden" name="bf[behaviour][rounded_img]" value="0" data-disable-adv="rounded-img" />
                                                <span class="bf-def"></span><span class="bf-no"></span><span class="bf-yes"></span>
                                            </span>
                                        </td>
                                        <td colspan="3"> 
