    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="<?php echo $tool; ?>" data-toggle="tooltip" title="<?php echo $button_tool; ?>"class="btn btn-default" /><i class="fa fa-spinner"></i> <?php echo $button_tool; ?></a>
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->input('barcode'); ?>
                            <?php $widgets->input('sku'); ?>
                            <?php $widgets->input('upc'); ?>
                            <?php $widgets->input('connect_symbol'); ?>
                            <?php $widgets->input('quantity_default'); ?>
                            <?php $widgets->input('zero_quantity'); ?>
                            <?php $widgets->input('admins_email'); ?>
                        ...
                        <div class="tab-pane" id="tab-logs">
                            ...
                            <textarea rows="20" class="form-control"><?php echo $logs; ?></textarea>
                        </div> 
                        <?php } ?>
