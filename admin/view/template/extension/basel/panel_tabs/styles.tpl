...
<div class="form-group">
    ...
    <div class="col-sm-10">
    <div class="input-group form-inline colorfield">
    <span class="input-group-addon"><i style="background:<?php echo isset($basel_top_line_bg) ? $basel_top_line_bg : '#ff1c00'; ?>"></i></span>
    <input class="form-control" name="settings[basel][basel_top_line_bg]" value="<?php echo isset($basel_top_line_bg) ? $basel_top_line_bg : '#ff1c00'; ?>" />
    </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    <div class="input-group form-inline colorfield">
    <span class="input-group-addon"><i style="background:<?php echo isset($basel_header_accent) ? $basel_header_accent : '#ff1c00'; ?>"></i></span>
    <input class="form-control" name="settings[basel][basel_header_accent]" value="<?php echo isset($basel_header_accent) ? $basel_header_accent : '#ff1c00'; ?>" />
    </div>
    </div>
</div>
