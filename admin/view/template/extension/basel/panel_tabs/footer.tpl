...
<tbody>
  <tr id="column-row<?php echo $footer_column_row; ?>">
    ...
    <td class="text-right">
    <input type="text" class="form-control" style="width:60px" name="settings[basel][basel_footer_columns][<?php echo $footer_column_row; ?>][sort]" value="<?php echo isset($basel_footer_column['sort']) ? $basel_footer_column['sort'] : '0'; ?>" />
    </td>
  </tr>
</tbody>
</table>
<table id="links-holder-<?php echo $footer_column_row; ?>" class="table table-clean">
    ...
    <td class="first">
    <input type="text" class="form-control" style="width:60px" name="settings[basel][basel_footer_columns][<?php echo $footer_column_row; ?>][links][<?php echo $footer_link_row; ?>][sort]" value="<?php echo isset($link['sort']) ? $link['sort'] : ''; ?>" />
    </td>
    <td class="text-right">
...
function addFooterColumn() {
	...
	html += '<input type="text" class="form-control" style="width:60px" value="0" name="settings[basel][basel_footer_columns][' + footer_column_row + '][sort]" />';
	html += '</td>';
	html += '</tr>';
	html += '</tbody>';
	html += '</table>';
...
function addFooterLink(footer_column_row) {
	...
	html += '</td>';
	html += '<td class="first">';
	html += '<input type="text" style="width:60px" class="form-control" name="settings[basel][basel_footer_columns][' + footer_column_row + '][links][' + link_row + '][sort]" value="0" />';
