...
<div id="content">
  <div class="page-header">
	...
	<button type="submit" form="form-basel" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    <a class="btn btn-default" href="http://basel.openthemer.com/help" target="_blank" data-toggle="tooltip" title="Documentation" ><i class="fa fa-book"></i></a>
    </div>
  ...
  <div class="container-fluid">    
   ...
   <div class="setting-header">v 1.2.1</div>
