...
class ModelExtensionModuleNeoSeoPriceImport extends NeoSeoModel
{
	...
	public function installTables()
	{
        ...
        $sql = "SHOW COLUMNS FROM `" . DB_PREFIX . "price_import_vendor` LIKE 'price_coefficient_by_category';";
        $query = $this->db->query($sql);
        if (!$query->num_rows) {
            $sql = "ALTER TABLE `" . DB_PREFIX . "price_import_vendor` ADD COLUMN `price_coefficient_by_category` TEXT";
            $this->db->query($sql);
        }
		return TRUE;
	}
