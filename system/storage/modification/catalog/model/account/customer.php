...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		require('admin/model/extension/module/sendpulse.php');
		$adminSendpulseModel = new ModelExtensionModuleSendpulse( $this->registry );
		$adminSendpulseModel->exportNewCustomer($data);
