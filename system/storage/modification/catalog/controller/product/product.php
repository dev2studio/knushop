...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['text_entry_not_size'] = $this->language->get('entry_not_size');
			$data['entry_not_size_later'] = $this->language->get('entry_not_size_later');

			$data['text_share1'] = $this->language->get('text_share1');
			$data['text_share2'] = $this->language->get('text_share2');
			$data['text_share3'] = $this->language->get('text_share3');
			$data['text_share4'] = $this->language->get('text_share4');
 

			$data['text_care'] = $this->language->get('text_care');
		...
		include_once(DIR_APPLICATION . 'controller/extension/basel/product_helper.php');
		}
