...
class ControllerCommonDashboard extends Controller {
	public function index() {
		...
		$data['alert_senpulse'] = (($this->model_extension_module_sendpulse->getTotalClients() <= $this->config->get('sendpulse_count'))?"":sprintf($this->language->get('text_alert_sendpulse'), $this->url->link('extension/module/sendpulse', 'token=' . $this->session->data['token'], true)));
