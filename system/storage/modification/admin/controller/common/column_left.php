		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/
			...
			if ($this->user->hasPermission('access', 'extension/basel/basel')) {
				$basel[] = array(
					'name'	   => 'Theme Settings',
					'href'     => $this->url->link('extension/basel/basel', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/basel/question')) {
				$basel[] = array(
					...
					'href'     => $this->url->link('extension/basel/question', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/basel/product_tabs')) {
				$basel[] = array(
					'name'	   => 'Product Tabs',
					'href'     => $this->url->link('extension/basel/product_tabs', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/basel/testimonial')) {
				$basel[] = array(
					'name'	   => 'Testimonials',
					'href'     => $this->url->link('extension/basel/testimonial', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/basel/subscriber')) {
				$basel[] = array(
					...
					'href'     => $this->url->link('extension/basel/subscriber', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/basel/productgroups')) {
				$basel[] = array(
					'name'	   => 'Product Groups',
					'href'     => $this->url->link('extension/basel/productgroups', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/onepagecheckout')) {
				$basel[] = array(
					...
					'href'     => $this->url->link('extension/onepagecheckout', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
			if ($basel) {
