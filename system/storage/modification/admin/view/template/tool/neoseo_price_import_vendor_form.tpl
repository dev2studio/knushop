                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-attribute" class="form-horizontal">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-price">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label class="control-label"><?php echo $entry_price_coefficient_by_category; ?></label>
                                    <br><?php echo $entry_price_coefficient_by_category_desc; ?>
                                </div>
                                <div class="col-sm-5" style="padding-top: 12px;">
                                    <textarea rows="8" name="item[price_coefficient_by_category]" id="input-defaults" class="form-control"><?php echo $item['price_coefficient_by_category']; ?></textarea>
                                </div>
                            </div>
