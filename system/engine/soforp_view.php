...
class SoforpWidgets
{
	...
	{
		?>
        <div class="form-group" id="field_<?php echo $property; ?>" style="<?php echo (isset($params['disabled']) && $params['disabled'])? 'display:none' : 'display: inline-block; width: 100%;'; ?>">            <div class="col-sm-5">
